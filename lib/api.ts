  ...
  try {
    ...
    return {
      homepage: {
        ...
        aboutHeading: homepage.aboutHeading || "Hello.",
        aboutText: homepage.aboutText || "At J & M Painting, we are artisans of refined living. Specializing in high-end painting, kitchen restoration, and luxury remodeling across the Triangle. We bring precision and creativity to elevate your space.",
      },
      services,
    ...
    return {
      homepage: {
        ...
        aboutHeading: "Hello.",
        aboutText: "At J & M Painting, we are artisans of refined living. Specializing in high-end painting, kitchen restoration, and luxury remodeling across the Triangle. We bring precision and creativity to elevate your space.",
      },
      services: [],
      allPhotos: [],
      showcaseProjects: []
